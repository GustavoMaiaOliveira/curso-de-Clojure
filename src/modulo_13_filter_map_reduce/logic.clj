...
;Desafio final: Crie uma função que recebe um vetor de nomes e retorne o tamanho médio dos nomes, mas deve-se ignorar nomes com
; 3 ou menos caracteres.
